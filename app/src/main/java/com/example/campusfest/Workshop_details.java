...
public class Workshop_details extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        l1.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                openGoogleMaps("Velammal College of Engineering",
                        "https://www.google.com/maps?q=Velammal+Engineering+College,Chennai,Tamil+Nadu+600066");
            }
        });
        ...
        l2.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                openGoogleMaps("RMK Engineering College",
                        "https://www.google.com/maps?q=RMK+Engineering+College,Tamil+Nadu+601206");
            }
        });
        ...
        l3.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                openGoogleMaps("SRM Institute of Science and Technology",
                        "https://www.google.com/maps?q=SRM+Institute+of+Science+and+Technology,Chennai,Tamil+Nadu+600089");
            }
        });
    }
